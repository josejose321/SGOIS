        ...
        <div class="col-lg-4">
            <div class="card mb-3 ">
                <div class="card-body text-center shadow">
                    <img class="rounded-circle mb-3 mt-4 w-50"src="{{ Storage::url('avatar/6g4mgyJXAJ7hVC1tolnCBT6u7FjEHrksdJG07n3d.jpg') }}">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ route('employee.update', $employee->employee_no) }}" method="POST">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label" for="username"><strong>employee No</strong></label>
                                            <input class="form-control" type="text" value="{{ $employee->employee_no ?? '' }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>First Name</strong></label>
                                            <input class="form-control" type="text" id="first_name" name="firstname" value="{{ $employee->firstname ?? "" }}">
                                        </div>
                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Middle Name</strong></label>
                                            <input class="form-control" type="text" id="first_name-2" name="middlename"value="{{ $employee->middlename ?? '' }}">
                                        </div>
                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Last Name</strong></label>
                                            <input class="form-control" type="text" id="first_name-1" name="lastname"value="{{ $employee->lastname ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
