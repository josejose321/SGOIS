                    ...
                    <form id="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_no" id="id" class="form-control"
                                        placeholder="Student No" readonly value="{{ $student->student_no }}">
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="semester" id="id" class="form-control"
                                        placeholder="Student No" readonly value="year 2022 2nd semester">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="extrainfo" name="extra" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <select class="form-select" name="scholarhipOffice" id="scholarhip"
                                    aria-label="Default select example">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="discount" id="inlineRadio1"
                                        value="25">
                                    <label class="form-check-label" for="inlineRadio1">25%</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="discount" id="inlineRadio2"
                                        value="50">
