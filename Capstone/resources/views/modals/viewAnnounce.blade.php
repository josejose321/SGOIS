...
<form action="{{ route('admin.announce.update',$announcement->id) }}" method="post">
  @csrf
  <div class="modal fade" id="viewAnnouce-{{ $announcement->id }}" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control fw-bold" name="subject" id="subject" value="{{ $announcement->subject }}">
          </div>
