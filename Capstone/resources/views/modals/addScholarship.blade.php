<form action="{{ route('student.apply.scholarship', $student->student_no) }}" method="POST" enctype="multipart/form-data">
  @csrf
            ...
            <div class="modal-body bg-light">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <label for="semester">Student_no</label>
                      <input type="text" name="student_no" class="form-control" readonly value="{{ $student->student_no ?? '' }}">
                  </div>
                  <div class="col-md-4">
                    <label for="type">Type</label>
                    <select class="form-select form-select-md mb-3" name="type" id="type" aria-label="Default select example">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="semesterCode" id="id" class="form-control" readonly value="{{ $sem->semesterCode ?? '' }}">
                    </div>
                  </div>
                  <div class="col-md-4">
                        <label for="scholarship">Scholarship Office</label>
                        <select class="form-select form-select-md mb-3" name="officeCode" id="office" aria-label="Default select example">
                ...
                <div class="row">
                  <div class="col-md-4">
                        ...
                        <select class="form-select form-select-md mb-3" name="categoryNo" id="category" aria-label="Default select example">
