    ...
    <div>
        <nav class="navbar navbar-light navbar-expand-md sticky-top navigation-clean-button" style="height: 80px;color: #ffffff;background: var(--bs-gray-600);">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navcol-1" style="background: var(--bs-gray-600);width: 1000px;">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" style="color: #ffffff;background: transparent;" href="{{ route('student.index') }}">&nbsp;Home</a></li>
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="color: var(--bs-body-bg);">ApplyNow</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="color: var(--bs-body-bg);"><img class="rounded-circle" src="{{ Storage::url('avatar/defaultAvatar.jpg') }}" style="width: 32px;height: 32px;"></a>
