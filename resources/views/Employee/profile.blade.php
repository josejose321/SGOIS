            ...
            <div class="col-lg-4">
                <div class="card mb-3 ">
                    <div class="card-body text-center shadow">
                        <form action="{{ route('employee.avatar.update', $user->userNo) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <label for="avatar">
                                <img class="rounded-circle mb-3 mt-4 w-50"
                                    src="{{ Storage::url('avatar/'. $user->avatar ?? '') }}">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form action="{{ route('employee.profile.update', $user->userNo) }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="officeCode" name="officeCode"
                                                    value="{{ $user->employee->office->name ?? '' }}" maxlength="11" disabled>
                                            </div>
                                        </div>
