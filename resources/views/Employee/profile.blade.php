            ...
            <div class="col-lg-4">
                <div class="card mb-3 ">
                    <div class="card-body text-center shadow">
                        ...
                        <form action="{{ route('employee.avatar.update', $employee->employee_no) }}" method="post"
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text"
                                                    value="{{ $employee->user->user_id ?? '' }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="officeCode" name="officeCode"
                                                    value="{{ $employee->user->employee->office->name ?? '' }}" maxlength="11" disabled>
                                            </div>
                                        </div>
