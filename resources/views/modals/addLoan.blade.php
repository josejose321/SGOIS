<form action="{{ route('student.apply.loan', Auth::user()->student ?? '') }}" method="POST"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header bg-dark text-light">
                    <h3> <i class="fa fa-basketball-ball"></i> Loan Form</h3>
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="type" class="form-control" readonly value="Loan">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
