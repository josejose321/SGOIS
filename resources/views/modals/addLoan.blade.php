<form action="{{ route('student.apply.scholarship', Auth::user()->student ?? '') }}" method="POST"
    ...
    @csrf
    <div class="modal fade bd-example-modal-lg" id="loanModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header bg-dark text-light">
                    <h3> <i class="fa fa-money"></i>Loan Form</h3>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-md mb-3" name="categoryNo" id="category"
                                ...
                                @forelse ($loans as $loans)
                                    <option value="{{ $loans->categoryNo }}">{{ $loans->name }}</option>
                                    @empty
