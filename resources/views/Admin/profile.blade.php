            ...
            <div class="col-lg-4">
                <div class="card mb-3 ">
                    <div class="card-body text-center shadow">
                        <form action="{{ route('admin.profile.updateAvatar', $employee->employee_no) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <label for="avatar">
                                <img class="rounded-circle mb-3 mt-4 w-50"
                                    src="{{ Storage::url('avatar/'. $employee->user->avatar ?? '') }}">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.update', $employee->employee_no) }}" method="POST">
                                    @csrf
                                    @if ($errors->any())
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                <label class="form-label" for="username"><strong>Admin
                                                        No</strong></label>
                                                <input class="form-control" type="text" value="{{ $employee->user->user_id ?? '' }}"
                                                    disabled>
                                            </div>
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mb-3"><label class="form-label"
                                                ...
                                                <input class="form-control" type="text" id="first_name-2"
                                                    name="middlename" value="{{ $employee->user->middlename ?? '' }}">
                                            </div>
                                            <div class="mb-3"><label class="form-label"
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="phone" name="phone"
                                                    value="{{ $employee->user->phone ?? '' }}" maxlength="11">
                                            </div>
                                        </div>
