    ...
    <div class="p-2 mb-4 rounded-3 animate__animated animate__fadeInDown text-light"
        ...
        <div class="container-fluid py-5">
            ...
            <p class="col-md-8 fs-4">The Scholarship and Grants Office are offering Scholarships to students who
                ...
                Instructions: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat atque exercitationem
                facilis illo nulla officiis at rem
                earum recusandae magnam non enim impedit, sequi ex consequuntur corporis illum a molestiae! </p>
            <button class="btn btn-success btn-lg" type="button" data-target="#varsityModal" data-toggle="modal">Click
