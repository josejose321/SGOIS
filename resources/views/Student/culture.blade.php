...
@section('title', 'SGOIS-CULTURE AND ARTS')
@section('background')
    <style>
        body,
        html {
    ...
    <div class="container-fluid py-4 animate__animated animate__fadeInUp">
        ...
        <div class="p-2 mb-4 rounded-3 animate__animated animate__fadeInDown text-light"
            ...
            <header class="pb-3 mb-4 border-bottom" style="background-color: rgba(74, 74, 74, 0.90)">
                <span class="fs-4 h2 fw-bold p-2 m-1 text-light"><i class="fa fa-music"></i> UNC Culture And Arts
                    SCHOLARSHIP</span>
            </header>
            <div class="container-fluid py-5">
                {{-- <h1 class="display-5 fw-bold"> <i class="fa fa-music"></i> APPLY NOW!</h1> --}}
                ...
                <button class="btn btn-success btn-lg text-light" type="button" data-target="#cultureModal"
