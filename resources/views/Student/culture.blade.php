  ...
  <div class="container-fluid py-4">
    <header class="pb-3 mb-4 border-bottom bg-danger">
      <a href="#" class="d-flex align-items-center text-dark text-decoration-none p-3 m-3">
        <span class="fs-4 h2 fw-bold"><i class="fa fa-running"></i> UNC CULTURE AND ARTS SCHOLARSHIPS</span>
      </a>
    </header>
    ...
    <div class="p-2 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        ...
        <button class="btn btn-primary btn-lg" type="button" data-target="#varsityModal" data-toggle="modal">Click Here..</button>
      </div>
    </div>
